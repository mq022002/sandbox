    ...
    <main className="flex min-h-screen flex-col p-6">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          {/* This is a copy-paste pre-styled component using Tailwind CSS to create a black triangle. */}
          {/* <div
            className="h-0 w-0 border-b-[30px] border-l-[20px] border-r-[20px] border-b-black border-l-transparent border-r-transparent"
          /> */}

          {/* https://nextjs.org/learn/dashboard-app/css-styling#css-modules */}
          {/* Alternative implementation of the above, using CSS modules instead. */}
